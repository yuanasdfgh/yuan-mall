...
public class MybatisPlusGenerator {
    ...
    // 配置数据库信息
    private static final String URL = "jdbc:mysql://localhost:3306/yuan_mall?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&nullCatalogMeansCurrent=true";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "123456";
    // 项目根目录
    // mall/mall-admin
    private static final String PROJECT_ROOT_PATH = System.getProperty("user.dir") + "/mall-admin";

    // 生成文件存储地址
    private static final String BASE_PATH = PROJECT_ROOT_PATH + "/src/main/java/com/admin";
    private static final String PARENT_PACKAGE_NAME = "com.admin";
    ...
    private static void codeGenerator() {
        // 六个文件的路径
        String entityPath = BASE_PATH + "/pojo";
